...
function renderGrades() {
  ...
  summary.innerHTML = `<div class="analytics-card"><span>Current Average</span><strong>${average}%</strong></div><div class="analytics-card"><span>Weight Logged</span><strong>${weight}%</strong></div>`;
